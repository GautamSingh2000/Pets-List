...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    Toast.makeText(EditorActivity.this, "Please enter gender", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                // calling insertRealValue method to insert values into database
                if (mNameEditText.getText().toString().isEmpty()  || mWeightEditText.getText().toString().isEmpty()) {
                    Toast.makeText(this, "Please enter all the details!", Toast.LENGTH_SHORT).show();
                }
                if(mBreedEditText.getText().toString().isEmpty())
                {
                 mBreedEditText.setText("Uknown Breed");
                }
                else {
                    savePet();
                    finish();
    ...
    private void savePet() {
        ...
        //here we are tragiting the mNameEditText editable and getting the text save into it and
        //converting it into String using toString() and triming white spaces by using trim() function.
        ...
        int WeightInt = Integer.parseInt(weightString);
            ...
            if (mCurrentPetUri == null) {
                ...
                if (rowsAffected == 0) {
                    ...
                    Toast.makeText(this, "update_pet_failed",
                            Toast.LENGTH_SHORT).show();
                } else {
                    // Otherwise, the update was successful and we can display a toast.
                    Toast.makeText(this, "update_pet_successful",
                            Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private void deletePet() {
       ...
       int  rawDeleted = getContentResolver().delete(mCurrentPetUri,null,selectionArgs);
